      ...
      <main className="arch-main">
        ...
        <div className="page-head">
          <div className="page-head-row">
            <div>
              <div className="page-eyebrow">{t("rt.hero.eyebrow")}</div>
              <h1>{t("rt.hero.title")}</h1>
              <p className="muted">{t("rt.hero.sub")}</p>
            </div>
            <div className="rt-head-stats">
              <span><strong>{catalogCount}</strong> attacks</span>
              <span><strong>9</strong> categories</span>
              <span><strong>~120 s</strong> runtime</span>
              <span><strong>0–100</strong> score</span>
            </div>
          </div>
        </div>
            ...
            {agents === null && !agentsError ? (
              ...
              (agents ?? []).map((a) => (
                <div
                  ...
                  onClick={() => {
                    window.location.href = `/agents?id=${encodeURIComponent(a.id)}`;
                  }}
                  role="link"
                  tabIndex={0}
                  onKeyDown={(e) => {
